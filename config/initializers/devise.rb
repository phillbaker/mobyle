...
Devise.setup do |config|
  ...
  config.mailer_sender = "notifications@mobyle.phillbaker.com"
  ...
  # config.pepper = "aae4189dc2bc9efda420e78fd6d9b093d62ef92a252039ac63be517dc42975266982a445e82918927ff3aefe8b284b080a7402f4dbb18c9a85eaa35674766b5c"

  # ==> Configuration for :invitable
  # The period the generated invitation token is valid, after
  # this period, the invited resource won't be able to accept the invitation.
  # When invite_for is 0 (the default), the invitation won't expire.
  config.invite_for = 100.weeks
  ...
  config.allow_unconfirmed_access_for = 100.weeks #TODO do this for dev only, set prod to lower
